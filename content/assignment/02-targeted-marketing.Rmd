---
title: "Practical 2 : targeted marketing"
editor_options:
...
Paste into your RMarkdown file the notes from [this document](), which contains an outline/skeleton of what you'll need to complete the practical. Save the file with an appropriate name (`practical2`).
...
You should relate the form of `ggplot2` specifications -- the `ggplot2` _grammar_ -- to the _encodings_ of data and visual channels discussed in [GEOG5032's](http://www.roger-beecham.com/GEOG5042-data-visualization/index.html) session on Data Visualization in Tableau.
...
temp_plot_data %>%
  ...
  mutate(
    stat_type=as_factor(stat_type, levels=c("focus_prop","control_prop","diff_prop")),
